...
async function profitablity_checks(mapped_paths) {
  console.log("Número de paths recibidos para verificación:", mapped_paths.length);
  ...
  console.log("Paths rentables después de off_chain_check:", ordered_profitable_path_with_optimal_input_amount.length);
